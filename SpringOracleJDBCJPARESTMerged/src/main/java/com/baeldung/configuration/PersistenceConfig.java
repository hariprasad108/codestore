...
@ComponentScan({"com.baeldung.configuration", "com.baeldung.application", "com.baeldung.persistence", "com.baeldung.service"})
public class PersistenceConfig {
    ...
    public PersistenceConfig() {
        super();
        logger.info("***PersistenceConfig from SpringOracleJDBCJPARESTMerged ***");
    }
    ...
    /** optional, Spring entityManagerFactory cannot coexists with Hibernate sessionFactory */
